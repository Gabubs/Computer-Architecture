...
LinhasExtremos:
	...
	addi $12,$0, 7296 # Começo da borda de baixo
...
Segundo:	add $8,$0,$5
	add $4,$0,0xFFFFFFF # cor temp do sapo
	add $9, $0, 56
	mul $10,$9,418 # e 428
...
prox_linha_tronco:
	# Usa $14 + 1 para a linha seguinte, mas $9 n�o muda
	addi $15, $14, 1
	mul $11, $15, 128
	add $11, $11, $10
	mul $11, $11, 4
...
#=========SUBFUN��O: desenhaGrupoCirculos==========
desenhaGrupoCirculos:
    li $12, 0  # contador de c�rculos
...
avanca_circulo:
    addi $9, $9, -2     # volta para linha original
    addi $10, $10, 8    # espa�o entre c�rculos
    addi $12, $12, 1
    j circular_loop
